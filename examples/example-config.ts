...
const config: KeeperConfig = {
  ...
  // Operator must fill all placeholder addresses before enabling
  // LiquiditySource.SUSHISWAP or PostAuctionDex.SUSHISWAP; startup validation
  // requires swapRouterAddress, quoterV2Address, factoryAddress, and wethAddress.
