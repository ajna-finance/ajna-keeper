...
import { configureAjna, LiquiditySource } from '../../src/config';
...
import { arrayFromAsync, weiToDecimaled } from '../../src/utils';
...
type LiveLiquidityFixture = typeof MAINNET_UNISWAP_SOL_WETH_FIXTURE;
...
describe('Live liquidity end-to-end factory execution', function () {
  ...
  it('executes a pinned Ajna liquidation through real Uniswap V3 liquidity', async () => {
    ...
    expect(quoteEvaluation.selectedFeeTier).to.equal(
      fixture.uniswap.defaultFeeTier
    );
    expect(
