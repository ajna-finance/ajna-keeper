...
- Let type errors drive cleanup in factory route selection, validation,
  preflight, discovery config plumbing, gas conversion, reward swaps, deployment
  scripts, docs, examples, and tests.
